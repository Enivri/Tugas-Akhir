import { Wrapper, Title, Report, ReportTitle, Label, Control, Group, Content, SubTitle, Bottom, SubmitBTN, CancelBTN, Formx } from './SignUp.styles'
...
const AddPatient = () => {
    ...
    return (
        <Wrapper>            
            <Report>
                <ReportTitle>Sign Up Form</ReportTitle>

                <Content className='my-3'>
                        <SubTitle>Identitas</SubTitle>
